...
void NormalCourse::runNormalCourse()
{
  ...
  constexpr std::array<NormalCourseProperty, arraySize> normalCoursePropertyL
       ...
       */
      = { {
          { 600, baseSpeed, { 0.1, 0.0, 0.0 }, { 0.45, 0.01, 0.03 } },        // 第1区間
          { 800, baseSpeed - 5, { 0.1, 0.0, 0.0 }, { 0.45, 0.0, 0.035 } },     // 第2区間
          { 1300, baseSpeed, { 0.1, 0.0, 0.0 }, { 0.45, 0.0, 0.02 } },        // 第3区間
          { 760, baseSpeed - 12, { 0.1, 0.0, 0.0 }, { 0.45, 0.005, 0.035 } },  // 第4区間
          { 740, baseSpeed - 14, { 0.1, 0.0, 0.0 }, { 0.45, 0.005, 0.035 } },  // 第5区間
          { 460, baseSpeed - 12, { 0.1, 0.0, 0.0 }, { 0.45, 0.005, 0.04 } },  // 第6区間
          { 1290, baseSpeed, { 0.1, 0.0, 0.1 }, { 0.4, 0.005, 0.03 } },      // 第7区間
          { 700, baseSpeed, { 1.8, 0.0, 0.1 }, { 0.4, 0.005, 0.03 } },        // 第8区間
          { 950, baseSpeed - 12, { 0.1, 0.0, 0.1 }, { 0.5, 0.005, 0.035 } },   // 第9区間
          { 750, baseSpeed - 7, { 0.1, 0.0, 0.1 }, { 0.55, 0.0, 0.04 } },     // 第10区間
          { 1900, baseSpeed - 5, { 0.1, 0.0, 0.1 }, { 0.55, 0.005, 0.04 } },   // 第11区間

          { 1500, baseSpeed / 2, { 0.1, 0.0, 0.1 }, { 0.4, 0.0, 0.04 } },  //進入ライン
