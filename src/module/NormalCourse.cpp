...
void NormalCourse::runNormalCourse()
{
  ...
  constexpr std::array<NormalCourseProperty, arraySize> normalCoursePropertyL
      ...
      = { {
          ...
          { 800, baseSpeed - 10, 0.00201, { 0.5, 0.005, 0.03 } },    // 第4区間
          { 708, baseSpeed - 10, 0.00335, { 0.6, 0.005, 0.03 } },    // 第5区間
          { 1285, baseSpeed - 10, -0.00320, { 0.65, 0.01, 0.04 } },  // 第6区間
          { 245, baseSpeed, 0.0, { 0.6, 0.005, 0.025 } },            // 第7区間
          { 780, baseSpeed, -0.00192, { 0.6, 0.005, 0.025 } },       // 第8区間
          ...
          { 2085, baseSpeed, 0.0, { 0.4, 0.005, 0.04 } },            //進入ライン
          { 466, baseSpeed, 0.00331, { 0.55, 0.0, 0.04 } },          //本番で要調整
      } };
  constexpr std::array<NormalCourseProperty, arraySize> normalCoursePropertyR
      ...
      = { {
          ...
          { 305, baseSpeed, 0.00255, { 0.4, 0.0, 0.02 } },         // 第2区間
          { 580, baseSpeed, 0.0, { 0.4, 0.0, 0.02 } },             // 第3区間
          { 405, baseSpeed - 10, 0.00201, { 0.4, 0.005, 0.03 } },  // 第4区間
          { 354, baseSpeed - 14, 0.00335, { 0.4, 0.005, 0.03 } },  // 第5区間
          { 534, baseSpeed - 10, 0.00316, { 0.4, 0.005, 0.03 } },  // 第6区間
          { 250, baseSpeed, 0.0, { 0.4, 0.005, 0.025 } },          // 第7区間
          { 353, baseSpeed, 0.00192, { 0.4, 0.005, 0.025 } },      // 第8区間
          { 900, baseSpeed - 11, 0.0, { 0.4, 0.005, 0.03 } },      // 第9区間
          { 302, baseSpeed - 11, 0.00251, { 0.5, 0.0, 0.03 } },    // 第10区間
          { 170, baseSpeed - 2, 0.0, { 0.5, 0.0, 0.03 } },         // 第11区間
          { 153, baseSpeed, 0.00256, { 0.5, 0.0, 0.03 } },         // 第12区間
          { 583, baseSpeed, 0.00287, { 0.5, 0.0, 0.03 } },         // 第13区間
          { 2085, baseSpeed / 3, 0.0, { 0.4, 0.0, 0.04 } },        //進入ライン
          { 233, baseSpeed / 4, 0.00331, { 0.55, 0.0, 0.04 } },    //本番で要調整
      } };
